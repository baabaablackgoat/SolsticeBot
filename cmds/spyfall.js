    ...
    if (bot._spyfall.hasOwnProperty(msg.channel.id)){
        ...
        msg.channel.send(`Initiating Spyfall game...`).then(spy_msg=>{
            ...
            collector.on("end",(data,col)=>{
                ...
                let location = Object.keys(locations)[randInt(0,Object.keys(locations).length-1)];
                let gamedata = {
                    location: location,
                    roles: locations[location], 
